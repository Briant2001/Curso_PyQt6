...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.generar_interface()
        self.show()

    def generar_interface(self):
        ...
        boton_suma.clicked.connect(self.isertar_operador)
        boton_resta.clicked.connect(self.isertar_operador)
        boton_multiplicacion.clicked.connect(self.isertar_operador)
        boton_division.clicked.connect(self.isertar_operador)


        boton_ce = QPushButton('CE')
        boton_ce.clicked.connect(self.borrar_todo)
        boton_borrar = QPushButton('Borrar')
        # boton_borrar.clicked.connect(self.pantalla.undo)
        boton_borrar.clicked.connect(self.borrar_uno_por_uno)
        ...
        #(widget, eje x, eje y, filas, columnas)
    ...
    def calcular_resultado(self):
        resultado = str(operations[self.operador](float(self.primer_valor), float(self.segundo_valor)))
